...
<td align="center" width="200" style="vertical-align: top; padding: 15px;">
  ...
  <p style="margin: 5px 0;">AI Core</p>
...
<!-- 최자슈아주원 -->
<td align="center" width="200" style="vertical-align: top; padding: 15px;">
  <img src="images/케케로.webp" width="160" style="border-radius: 50%;" alt="최자슈아주원"/>
  <h3 style="margin: 10px 0 5px 0;">최자슈아주원</h3>
  <p style="margin: 5px 0;">Backend Leadr</p>
...
<!-- 윤경은 -->
<td align="center" width="200" style="vertical-align: top; padding: 15px;">
  <img src="images/타마마.webp" width="120" style="border-radius: 50%;" alt="윤경은"/>
  <h3 style="margin: 10px 0 5px 0;">윤경은</h3>
  <p style="margin: 5px 0;">Backend & Frontend</p>
...
<!-- 안해빙 -->
<td align="center" width="200" style="vertical-align: top; padding: 15px;">
  <img src="images/기로로.webp" width="110" style="border-radius: 50%;" alt="안혜빈"/>
...
<!-- 정세연 -->
<td align="center" width="200" style="vertical-align: top; padding: 15px;">
  <img src="images/쿠루루.webp" width="98" style="border-radius: 50%;" alt="정세연"/>
...
<!-- 신지용 -->
<td align="center" width="200" style="vertical-align: top; padding: 15px;">
  <img src="images/우주.webp" width="98" style="border-radius: 50%;" alt="신지용"/>
...
- 학습 자료를 기반으로 문제 자동 생성
- 객관식 / OX / 단답형 등 다양한 퀴즈 제공
...
> **`Chat` / `Note` 모드 분리로 학습 목적에 따른 인터페이스 제공**
- **좌측**: 학습 자료 및 질문 히스토리
- **중앙**: 대화 및 학습 핵심 영역
- **우측**: 학습 보조 도구(Studio)
