    ...
    container.innerHTML = `
        <div class="quiz-card">
            <div class="quiz-header-row">
                ...
                <button class="quiz-bookmark-btn ${bookmarkClass}" onclick="toggleQuizBookmark(this)" title="북마크 저장"><svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M19 21l-7-5-7 5V5a2 2 0 0 1 2-2h10a2 2 0 0 1 2 2z"></path></svg></button>
            </div>
