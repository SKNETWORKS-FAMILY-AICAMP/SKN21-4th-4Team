...
function showWelcome() {
    ...
    document.getElementById('chatContent').innerHTML = `
        <div class="welcome" id="welcome">
            <!-- 배지 제거됨 -->
            <img src="/static/images/pymate_logo.png" alt="PyMate" style="width: 220px; height: auto; margin-bottom: 30px; border-radius: 16px;">
            <h1>무엇을 배우고 싶으세요?</h1>
    ...
    div.innerHTML = `
        <div class="message-header">
            <div class="message-avatar">
                <img src="/static/images/pymate_logo.png" alt="AI" style="width: 100%; height: 100%; border-radius: 50%;">
            </div>
